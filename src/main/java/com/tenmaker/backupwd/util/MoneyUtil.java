...
public class MoneyUtil {
	...
	public static void main(String[] args) {
		System.out.println(MoneyUtil.fraction2rmb("12"));
		System.out.println(MoneyUtil.moneyFormat("12453422432453453.2803"));
		System.out.println(MoneyUtil.convertCN("123223423423.28"));
		System.out.println("dsfsfd="
				+ MoneyUtil.format(new BigDecimal("2342423423.423234234")));
		System.out.println("dsfsfd="
				+ MoneyUtil
						.formatOfRead(new BigDecimal("234242342342323423.4")));
		System.out.println(MoneyUtil.insertComma("2343242342344242.3", 2));
		System.out.println(MoneyUtil.delComma("234,242,342,342,323,423.40"));
	}
}
